  ...
  return (
    <div ref={featuresRef} className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl relative z-10">
      {[
        ...
        <div 
          key={index} 
          className="bg-gray-100 dark:bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-indigo-500 transition-all duration-300"
        >
